...
public class DetailFavouriteTeams extends AppCompatActivity {
    Bundle extras;
    String title;
    String date;
    String deskripsi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_favourite_teams);
        ...
        if (extras != null) {
            ...
            Glide.with(DetailFavouriteTeams.this)
                    .load(path)
